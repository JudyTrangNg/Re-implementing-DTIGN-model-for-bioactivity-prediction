...
class DTIGN(torch.nn.Module):
    def __init__(self, in_dim=35, bond_dim=10, hidden_dim = 256, n_layers=3, n_heads=4):
        super().__init__()
    ...
    def forward(self, data):
        ...
        if hasattr(data, "batch"):
            ...
            reps = global_add_pool(x, data.batch) # thay global_mean_pool bang global_add_pool
